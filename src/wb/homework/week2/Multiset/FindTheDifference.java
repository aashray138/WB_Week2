...
public class FindTheDifference {
	...
	public static void main(String[] args) {
		...
		System.out.println("The difference value is ->" + findTheDifference(s, t));
	...
	public static char findTheDifference(String s, String t) {
		...
		for(char chz : t.toCharArray()) {
			if (!map.containsKey(chz)) {
				return chz;
			}else{ 
                int count = map.get(chz); 
                if (count > 1){
                    map.put(chz, map.get(chz)-1);
                }else {
                    map.remove(chz);
                }
            }
